package com.mallcco.andy.laboratorio16

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.bumptech.glide.Glide
import com.mallcco.andy.laboratorio16.databinding.ListItemImgBinding
import java.io.File
...
class GalleryAdapter (private val fileArray: Array<File>) :
    ...
    class ViewHolder(private val binding: ListItemImgBinding) :
        ...
        fun bind(file: File) {
            Glide.with(binding.root).load(file.path).into(binding.localImg)
        }
